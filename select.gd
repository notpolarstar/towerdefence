...
export var ennemiG = preload("res://ennemiG.tscn")
var pos_ennemi = 1
var x = 0
var y = 0
var menu_ouvert = 0
...
func _ready():
	if Variables.Volume == true:
		$AudioStreamPlayer.playing = true
	Variables.Ressources = 1500
	Variables.Champs = 1
...
func _process(_delta):
	...
	if Variables.Vie_chateau <= 0:
		Variables.Vie_chateau = 0
		Game_over.dialog_text = "Perdu ! Vous avez survecu "+str(temps_total_str)+":"+str(temps_total)+"\nRecommencer ?"
		Game_over.popup()
...
func spawn_ennemi():
	...
	if spawn == 1:
		...
		var spawn2 = random.randi_range(0,9)
		if spawn2 == 1:
			var EnnemiG = ennemiG.instance()
			add_child(EnnemiG)
			EnnemiG.global_position = Vector2(48,240)
